<%@ Page Title="" Language="C#" MasterPageFile="~/Login1.master" AutoEventWireup="true" CodeFile="BookReturn.aspx.cs" Inherits="BookReturn" %>
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 flex-wrap gap-2">
        <h1 class="fw-bold page-title m-0">📓 Book Return Register</h1>
    ...
    <div class="row mb-5 g-3 justify-content-center search-section py-3 px-2 rounded-4 shadow-sm">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
            <asp:TextBox ID="txtSearchIssueID" runat="server" 
                CssClass="form-control border-success fw-bold text-success search-box" 
                placeholder="Issue ID."></asp:TextBox>
        </div>
                
        <!-- Book ID -->
        <div class="col-lg-2 col-md-4 col-sm-6">
            <asp:TextBox ID="txtSearchBookID" runat="server" 
                CssClass="form-control border-success fw-bold text-success search-box" 
        ...
        <!-- Student ID  -->
        <div class="col-lg-2 col-md-4 col-sm-6">
            <asp:TextBox ID="txtSearchStudentID" runat="server" 
                CssClass="form-control border-success fw-bold text-success search-box" 
        ...
        <!-- Issue Date -->
        <div class="col-lg-2 col-md-4 col-sm-6">
            <asp:TextBox ID="txtSearchIsDate" runat="server" 
                CssClass="form-control border-success fw-bold text-success search-box" 
                placeholder="Issue Date" TextMode="Date" ></asp:TextBox>
        </div>
        <!-- Return Date -->
        <div class="col-lg-2 col-md-4 col-sm-6">
            <asp:TextBox ID="txtSearcRehDate" runat="server" 
                CssClass="form-control border-success fw-bold text-success search-box" 
...
<div class="card border-0 shadow-lg mb-5 rounded-4 card-animate">
    ...
    <div class="card-body">
        <div class="row g-4">
            ...
            <!-- Auto-filled Fields -->
            <div class="col-md-4">
                <label for="txtIssueId" class="form-label fw-semibold">Issue ID</label>
                <asp:TextBox ID="txtIssueId" runat="server" CssClass="form-control shadow-sm input-focus" Enabled="False"></asp:TextBox>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label for="txtStuId" class="form-label fw-semibold">Student ID</label>
                <asp:TextBox ID="txtStuId" runat="server" CssClass="form-control shadow-sm input-focus" Enabled="False"></asp:TextBox>
            </div>
            ...
            <div class="col-md-4">
                <label for="txtBook" class="form-label fw-semibold">Book Name</label>
                <asp:TextBox ID="txtBook" runat="server" CssClass="form-control shadow-sm input-focus" Enabled="False"></asp:TextBox>
            </div>
            <div class="col-md-4">
                <label for="txtIssueDate" class="form-label fw-semibold">Issue Date</label>
                <asp:TextBox ID="txtIssueDate" runat="server" CssClass="form-control shadow-sm input-focus" Enabled="False" TextMode="Date"></asp:TextBox>
            </div>

        </div>

        <!-- Stylish Divider -->
        <hr class="styled-hr my-4">

        <!-- User Input Field -->
        <div class="row g-4">
            <div class="col-md-4">
                <label for="txtReturnDate" class="form-label fw-semibold">Return Date</label>
                <asp:TextBox ID="txtReturnDate" runat="server" CssClass="form-control shadow-sm input-focus" TextMode="Date" Enabled="False"></asp:TextBox>
            </div>

            <div class="col-md-4">
                <label for="lblStatus" class="form-label fw-semibold">Status</label><br />
                <asp:Label ID="lblStatus" runat="server"
                    CssClass="badge bg-warning text-dark fs-5 px-3 py-2 rounded-pill" Width="100%">Pending</asp:Label>
            </div>
        </div>
    </div>
</div>
...
<style>
    .styled-hr {
        ...
        height: 4px;
        border-radius: 10px;
        background: linear-gradient(to right, #42a5f5, #81d4fa, #b3e5fc);
        opacity: 0.9;
    ...
    <div class="card border-0 shadow-lg mb-4 rounded-4 card-animate">
        ...
        <div class="card-body text-center">
            <div class="d-flex flex-wrap gap-2 justify-content-center">
                ...
                <asp:Button ID="btnEdit" runat="server" Text="✏ Return" CssClass="btn btn-warning fw-bold text-dark action-btn rounded-pill" OnClick="btnEdit_Click" />

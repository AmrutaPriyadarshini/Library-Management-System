<%@ Page Title="" Language="C#" MasterPageFile="~/Login1.master" AutoEventWireup="true" CodeFile="BookIssue.aspx.cs" Inherits="BookIssue" %>
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 flex-wrap gap-2">
        <h1 class="fw-bold page-title m-0">📖 Book Issue Register</h1>
    ...
    <div class="card-body">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <asp:TextBox ID="txtIssueDate" runat="server" CssClass="form-control shadow-sm input-focus" TextMode="Date" Enabled="False"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <label for="txtBookName" class="form-label fw-semibold">Book Name</label>
                <asp:TextBox ID="txtBookName" runat="server" CssClass="form-control shadow-sm input-focus" Enabled="False"></asp:TextBox>
            </div>
            <div class="col-md-4">
